...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'public bot 𝘴𝘴 ᴄͥʀⷮᴇᷤᴀⷨᴛⷷɪᴏɴ' : process.env.ALL_CAPTION,
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? '𝘴𝘴 ᴄͥʀⷮᴇᷤᴀⷨᴛⷷɪᴏɴ' : process.env.BOT_NAME,
