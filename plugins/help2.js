...
Asena.addCommand({pattern: 'help', fromMe: false, desc: Lang.WP}, (async (message, match) => {
    ...
    r_text[2] = "https://avatars.githubusercontent.com/u/85664936?v=4.png";
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: `⛦━━━━━✨️JINN✨️━━━━━⛦
𝐇𝐞𝐥𝐥𝐨👋 𝐈 𝐚𝐦 𝐚 SACHUSAMU's 𝐛𝐨𝐭.
            *JINN*
■□■□■□■□■□■□■□■□■□■□
♕ *𝙈𝙚𝙙𝙞𝙖 𝘾𝙤𝙢𝙢𝙖𝙣𝙙𝙨* ♕
➡️𝘾𝙤𝙢𝙢𝙖𝙣𝙙➜ -song <text>
...
■□■□■□■□■□■□■□■□■□■□
═════💢JINN💢═════
▣▣▣▣▣▣▣▣▣ *_CODED:Karthik_terror-boy(WhiteDevil)_* ▣▣▣▣▣▣▣▣▣▣▣
`}) 
