    ...
    if (message.jid === '919562803423-1627735504@g.us') {
         ...
         let regex16 = new RegExp('Pm')
          if (regex1.test(message.message)) {              
            ...
            await message.client.sendMessage(message.jid,'my name is SACHUSAMU' , MessageType.text, {quoted: message.data })
         }
           ...
           await message.client.sendMessage(message.jid,'i know him he is my creator', MessageType.text, {quoted: message.data })
            ...
            await message.client.sendMessage(message.jid,'\n`SACHUSAMU ❣️` \n*github.com/sachusamu-c/JINN*', MessageType.text, {quoted: message.data })
         }
          else if (regex7.test(message.message)) {
            await message.client.sendMessage(message.jid,'```I am SACHUSAMU.```', MessageType.text, {quoted: message.data })
         }
